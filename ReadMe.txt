...
IsTagged.exe takes a single parameter on the command line indicating what file(s) to check. For example, to check a single file, run
IsTagged test.pdf
...
The program output may be captured in a text file using standard redirection, e.g.,
IsTagged c:\temp\*.pdf >report.txt
...
This documentation is also available online at http://EmpowermentZone.com/IsTagged.htm

The IsTagged.bas file contains the main source code for the program, built with the PowerBASIC compiler from
http://PowerBASIC.com

The QuickPDF library is used by the program, available from http://QuickPDFLibrary.com
